...
function Home() {
	return (
		<div className='py-5 px-5 md:px-5 lg:px-5 z-0'>
			<div className='text-center font-bold uppercase py-24'>
				<h1 className='text-5xl md:text-7xl lg:text-9xl mt-10 mb-2'>
					Photography
				</h1>
				<h2>Made Easy</h2>
			</div>
			...
			<div className='relative mt-10 '>
				<h2
					className='uppercase text-3xl md:text-5xl font-bold mb-3 md:mb-5 stroke'
					style={{ textStroke: '1px black' }}
				>
					Mission
				</h2>
